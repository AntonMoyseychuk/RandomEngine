...
bool engIsLogSystemInitialized() noexcept;
    ...
    #define ENG_LOG_ERROR(format, ...) LoggerError(Logger::Type::APPLICATION, false, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_WARN(format, ...)  LoggerWarn(Logger::Type::APPLICATION, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_INFO(format, ...)  LoggerInfo(Logger::Type::APPLICATION, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)

    #define ENG_LOG_WINDOW_ERROR(format, ...) LoggerError(Logger::Type::WINDOW_SYSTEM, false, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_WINDOW_WARN(format, ...)  LoggerWarn(Logger::Type::WINDOW_SYSTEM, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_WINDOW_INFO(format, ...)  LoggerInfo(Logger::Type::WINDOW_SYSTEM, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)

    #define ENG_LOG_GRAPHICS_API_ERROR(format, ...) LoggerError(Logger::Type::GRAPHICS_API, false, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_GRAPHICS_API_WARN(format, ...)  LoggerWarn(Logger::Type::GRAPHICS_API, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
    #define ENG_LOG_GRAPHICS_API_INFO(format, ...)  LoggerInfo(Logger::Type::GRAPHICS_API, true, __FILE__, __FUNCTION__, __LINE__, nullptr, format, __VA_ARGS__)
#else
