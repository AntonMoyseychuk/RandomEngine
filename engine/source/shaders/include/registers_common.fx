...
DECLARE_SRV_TEXTURE(sampler2D, COMMON_COLOR_TEX, 4, TEXTURE_FORMAT_RGBA16F, COMMON_SMP_CLAMP_LINEAR_IDX);
...
{
    float COMMON_SCREEN_WIDTH;
    float COMMON_SCREEN_HEIGHT;
